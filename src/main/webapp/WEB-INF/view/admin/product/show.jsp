                ...
                <body>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-auto">
                                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                                        ...
                                        <a class="btn btn-primary px-4" href="/admin/product/create"><i
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="product-box">
                                                                        <img src="/admin/images/top-products/${product.productImages[0].image}"
                                                            ...
                                                            <td>
                                                                <div class="product-tags">
                                                                    <a href="javascript:;"
                                                                        class="btn-tags">${product.brand.name}</a>
                                                            ...
                                                            <td>
                                                                <div class="product-rating">
                                                                    <a href="javascript:;"
                                                                        class="btn-tags">${product.status}</a>
                                                                    <!-- <i
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
                        ...
                        <div class="offcanvas-footer h-70 p-3 border-top">
                            <div class="d-grid">
                                <button type="button" class="btn btn-grd btn-grd-primary"
                                    data-bs-dismiss="offcanvas">View
                                    Products</button>
                            </div>
                        </div>
                    </div>
