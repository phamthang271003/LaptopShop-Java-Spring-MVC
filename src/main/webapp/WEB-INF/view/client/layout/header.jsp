...
<div class="top__header black-area pt-30 pb-30">
    <div class="container">
        <div class="top__wrapper">
            <a href="index-1.html" class="main__logo">
                <img src="/client/images/logo/logo.svg" alt="logo__image">
            </a>
            ...
            <div class="account__wrap">
                ...
                <div class="flag__wrap">
                    <div class="flag">
                        <img src="/client/images/flag/us.png" alt="flag">
                    </div>
                    <select name="flag">
                        <option value="0">
                            Usa
        ...
        <div class="header-wrapper">
            ...
            <div class="shipping__item d-none d-sm-flex align-items-center">
                <div class="menu__right d-flex align-items-center">
                    <div class="thumb">
                        <img src="/client/images/flag/picking.png" alt="image">
                    </div>
                    <div class="content">
                        <p class="text-white">
                            Picking up?
                ...
                <div class="menu__right d-flex align-items-center">
                    <div class="thumb">
                        <img src="/client/images/flag/shipping.png" alt="image">
                    </div>
                    <div class="content">
                        <p>
