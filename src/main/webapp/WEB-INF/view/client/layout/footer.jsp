...
<footer class="footer-area black-area bg-image" data-background="/client/images/footer/footer-bg.jpg">
    <div class="container">
        ...
        <div class="footer__copy-text pt-50 pb-50">
            <a href="index-1.html" class="logo d-block">
                <img src="/client/images/logo/logo.svg" alt="logo">
            </a>
            <p>&copy; Copyright 2023 <a href="#0" class="primary-hover">odor</a> All Rights Reserved</p>
            <a href="#0" class="payment d-block image">
                <img src="/client/images/icon/payment.png" alt="icon">
            </a>
        </div>
    </div>
</footer>
